...
const applyLanguage = (language) => {
  ...
  const copy = { ...translations[selectedLanguage], ...(highlightTranslations[selectedLanguage] || {}), ...languageSectionTranslations[selectedLanguage], ...(footerTranslations[selectedLanguage] || { copyrightBrand: '© 2026 HandyPet.', copyrightRights: 'All rights reserved.' }) };
