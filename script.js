...
const translations = {
  en: { navLabel: 'Main navigation', featuresNav: 'Features', privacyNav: 'Privacy', termsNav: 'Terms', eyebrow: 'Care, connected', heroTitle: 'Your pet’s health<br>records in one place', heroLede: 'Track vaccinations, vet visits, medications, and medical records—all in one secure place. Stay organized and keep your pet happy and healthy.', downloadLabel: 'Download HandyPet', android: 'Download for Android', ios: 'Download for iOS', secure: 'Secure & Private', sync: 'Cloud Sync', data: 'Your data, always yours', featuresTitle: 'HandyPet features', vaccinations: 'Vaccinations', vaccinationsText: 'Track vaccines and never miss an important dose.', vetVisits: 'Vet Visits', vetVisitsText: 'Log visits and keep a history of your pet’s health.', medications: 'Medications', medicationsText: 'Manage medications and set helpful reminders.', medicalRecords: 'Medical Records', medicalRecordsText: 'Store test results and records in one secure place.', weightLogging: 'Weight Logging', weightLoggingText: 'Track weight changes over time and follow your pet’s progress.', documentUploads: 'Document Uploads', documentUploadsText: 'Upload and organize important pet documents securely.', recordExports: 'Health Record Exports', recordExportsText: 'Export your pet’s complete health history as a convenient PDF.', customReminders: 'Custom Reminders', customRemindersText: 'Schedule pet reminders for the exact date and time you choose.', privacy: 'Privacy Policy', terms: 'Terms of Use', support: 'Support', languageLabel: 'Language', copyright: '© 2026 HandyPet. All rights reserved.' },
