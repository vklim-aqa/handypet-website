...
const highlightTranslations = {
  ...
  fr: { secure: 'Sécurisé et privé', secureText: 'Les données de votre animal sont chiffrées et toujours protégées.', sync: 'Synchronisation cloud', syncText: 'Accédez aux dossiers de votre animal à tout moment.', reminders: 'Rappels intelligents', remindersText: 'Ne manquez plus jamais un vaccin ou un médicament.', languageTitle: 'HandyPet parle votre langue', languageText: 'Nous sommes fiers d’accompagner les propriétaires d’animaux du monde entier.<br>Utilisez HandyPet dans la langue qui vous convient le mieux.' },
  de: { secure: 'Sicher und privat', secureText: 'Die Daten Ihres Tieres sind verschlüsselt und stets geschützt.', sync: 'Cloud-Synchronisierung', syncText: 'Greifen Sie jederzeit auf die Daten Ihres Tieres zu.', reminders: 'Smarte Erinnerungen', remindersText: 'Verpassen Sie nie wieder eine Impfung oder ein Medikament.', languageTitle: 'HandyPet spricht Ihre Sprache', languageText: 'Wir freuen uns, Tierhalter auf der ganzen Welt zu unterstützen.<br>Nutzen Sie HandyPet in der Sprache, die für Sie am angenehmsten ist.' },
  pt: { secure: 'Seguro e privado', secureText: 'Os dados do seu animal estão encriptados e sempre protegidos.', sync: 'Sincronização na nuvem', syncText: 'Aceda aos registos do seu animal a qualquer momento.', reminders: 'Lembretes inteligentes', remindersText: 'Nunca mais se esqueça de uma vacina ou medicamento.', languageTitle: 'O HandyPet fala a sua língua', languageText: 'Temos orgulho em apoiar famílias de animais em todo o mundo.<br>Use o HandyPet no idioma mais confortável para si.' }
};

const languageSectionTranslations = {
  en: { languageBadge: '5 LANGUAGES', languageTitle: 'Available in 5 languages', heroMessage: 'Healthy pets.<br>Happier lives.', exportKicker: 'PDF EXPORT', exportTitle: 'Export your pet\'s health record', exportText: 'Keep all important health information in one place and export it as a clean PDF anytime — perfect for vet visits, travel, or sharing with a new clinic.', exportProfile: 'Pet profile', exportRecords: 'Medical records', exportVaccinations: 'Vaccinations', exportWeight: 'Weight history', exportVisits: 'Vet visits', exportMedications: 'Active medications', exportNote: 'One tap. One complete health record.', exportCallout: 'Clean, professional<br>and ready to share!' },
  es: { languageBadge: '5 IDIOMAS', languageTitle: 'Disponible en 5 idiomas', heroMessage: 'Mascotas sanas.<br>Vidas más felices.', exportKicker: 'EXPORTAR PDF', exportTitle: 'Exporta el historial de salud de tu mascota', exportText: 'Mantén toda la información de salud importante en un solo lugar y expórtala como un PDF claro en cualquier momento, ideal para visitas al veterinario, viajes o compartirla con una nueva clínica.', exportProfile: 'Perfil de la mascota', exportRecords: 'Historial médico', exportVaccinations: 'Vacunas', exportWeight: 'Historial de peso', exportVisits: 'Visitas veterinarias', exportMedications: 'Medicamentos activos', exportNote: 'Un toque. Un historial de salud completo.', exportCallout: 'Limpio, profesional<br>y listo para compartir!' },
  fr: { languageBadge: '5 LANGUES', languageTitle: 'Disponible en 5 langues', heroMessage: 'Animaux en bonne santé.<br>Vies plus heureuses.', exportKicker: 'EXPORT PDF', exportTitle: 'Exportez le dossier de santé de votre animal', exportText: 'Conservez toutes les informations de santé importantes au même endroit et exportez-les à tout moment dans un PDF clair, idéal pour les visites vétérinaires, les voyages ou le partage avec une nouvelle clinique.', exportProfile: 'Profil de l’animal', exportRecords: 'Dossiers médicaux', exportVaccinations: 'Vaccinations', exportWeight: 'Historique du poids', exportVisits: 'Visites vétérinaires', exportMedications: 'Médicaments actifs', exportNote: 'Un geste. Un dossier de santé complet.', exportCallout: 'Clair, professionnel<br>et prêt à partager !' },
  de: { languageBadge: '5 SPRACHEN', languageTitle: 'In 5 Sprachen verfügbar', heroMessage: 'Gesunde Tiere.<br>Glücklicheres Leben.', exportKicker: 'PDF-EXPORT', exportTitle: 'Gesundheitsakte Ihres Tieres exportieren', exportText: 'Bewahren Sie alle wichtigen Gesundheitsinformationen an einem Ort auf und exportieren Sie sie jederzeit als übersichtliche PDF-Datei – ideal für Tierarztbesuche, Reisen oder zum Teilen mit einer neuen Praxis.', exportProfile: 'Tierprofil', exportRecords: 'Krankenakten', exportVaccinations: 'Impfungen', exportWeight: 'Gewichtsverlauf', exportVisits: 'Tierarztbesuche', exportMedications: 'Aktive Medikamente', exportNote: 'Ein Tipp. Eine vollständige Gesundheitsakte.', exportCallout: 'Übersichtlich, professionell<br>und bereit zum Teilen!' },
  pt: { languageBadge: '5 IDIOMAS', languageTitle: 'Disponível em 5 idiomas', heroMessage: 'Animais saudáveis.<br>Vidas mais felizes.', exportKicker: 'EXPORTAR PDF', exportTitle: 'Exporte o registo de saúde do seu animal', exportText: 'Mantenha todas as informações de saúde importantes num só lugar e exporte-as como um PDF claro a qualquer momento, ideal para consultas veterinárias, viagens ou partilha com uma nova clínica.', exportProfile: 'Perfil do animal', exportRecords: 'Registos médicos', exportVaccinations: 'Vacinas', exportWeight: 'Histórico de peso', exportVisits: 'Consultas veterinárias', exportMedications: 'Medicamentos ativos', exportNote: 'Um toque. Um registo de saúde completo.', exportCallout: 'Limpo, profissional<br>e pronto para partilhar!' }
};

const heroMarketingTranslations = {
  en: { heroLede: 'Keep health records, vaccinations, medications, weight, and documents organized. Get reminders when they matter and have a complete PDF health record ready to share.' },
  es: { heroLede: 'Mantén organizados los historiales de salud, las vacunas, los medicamentos, el peso y los documentos. Recibe recordatorios cuando importan y ten listo para compartir un historial de salud completo en PDF.' },
  fr: { heroLede: 'Organisez les dossiers de santé, les vaccinations, les médicaments, le poids et les documents. Recevez des rappels au bon moment et gardez un dossier de santé PDF complet prêt à partager.' },
  de: { heroLede: 'Organisieren Sie Gesundheitsakten, Impfungen, Medikamente, Gewicht und Dokumente. Erhalten Sie Erinnerungen, wenn sie wichtig sind, und halten Sie eine vollständige PDF-Gesundheitsakte zum Teilen bereit.' },
  pt: { heroLede: 'Mantenha organizados os registos de saúde, vacinas, medicamentos, peso e documentos. Receba lembretes quando são importantes e tenha um registo de saúde completo em PDF pronto para partilhar.' }
};
...
const applyLanguage = (language) => {
  ...
  const copy = { ...translations[selectedLanguage], ...(highlightTranslations[selectedLanguage] || {}), ...languageSectionTranslations[selectedLanguage], ...heroMarketingTranslations[selectedLanguage], ...(footerTranslations[selectedLanguage] || { copyrightBrand: '© 2026 HandyPet.', copyrightRights: 'All rights reserved.' }) };
